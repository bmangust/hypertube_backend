...
export const magenta = (text: string) => colorize('FgMagenta', text);
export const cyan = (text: string) => colorize('FgCyan', text);
export const white = (text: string) => colorize('FgWhite', text);
